...
$sqltags = mysql_query("select * from article_categories where link_categories='$tags'"); 
$cari_tags=mysql_fetch_array($sqltags);
$title_tags =ucfirst($cari_tags['title']); }?>

<!DOCTYPE html><html lang="id"><head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title><?PHP echo $title_tags;?> | <?PHP echo $title_web;?></title>
...
<meta property="og:title" content="<?PHP echo $title_tags;?> | <?PHP echo $title_web;?>">
...
$query_tags=mysql_query("select * from article where categories like '%$tags2%' order by article.id_article desc LIMIT $offset, $limit") or die(mysql_error());
...
<div class="paginate">
<ul class="pagination">
<?php $sql2  =mysql_query("SELECT COUNT(*) AS jumData FROM article where categories like '%$tags2%'");
$data  = mysql_fetch_array($sql2);
$url_page = "".MY_PATH."blog/tags/".$tags."/";
