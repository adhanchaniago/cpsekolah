var Script = function () {
        ...
        jQuery('#datapost .group-checkable').change(function () {
        ...
        jQuery('#datapost_wrapper .dataTables_filter input').addClass("input-medium"); // modify table search input
        jQuery('#datapost_wrapper .dataTables_length select').addClass("input-mini"); // modify table per page dropdown
