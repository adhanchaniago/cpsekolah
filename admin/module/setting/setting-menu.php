...
<?PHP $subid = abs((int)$_GET['subid']); if($subid != ''){ 
...
<form class="form_validation_ttip" name="form1" action="<?PHP echo MY_ADMIN?>submenu-proses/?id=<?PHP echo $subid;?>&act=editmenu" enctype="multipart/form-data" method="post">
...
<input class="span12" name="submenu_link" id="focusedInput" type="text" value="<?PHP echo $submenu_link; ?>" placeholder="Link Menu" required>
</div></div>
<div class="row-fluid"><div class="span12">
...
<div class="row-fluid"><div class="span12">
<label>Url Menu</label>
<input class="span12" name="menu_link" type="text" value="<?PHP echo $menu_link; ?>" placeholder="Link Menu" required></div></div>
<div class="row-fluid"><div class="span12">
...
<?PHP }?><?PHP if ($menu_number != $menu_last_number){?>
...
<?PHP $sql_submenu = mysql_query("select * from submenu ORDER by submenu.menu ASC, submenu.id ASC");
...
<a href="<?PHP echo MY_ADMIN;?>submenu-proses/?refid=<?php echo $submenu_id;?>&amp;act=delete" onClick="return confirm('Are you sure you want ot delete this thread.?');"><button class="btn btn-mini btn-danger ttip_t" title="Delete"><i class="icon-trash"></i></button></a></td></tr><?PHP }?></tbody></table>
</div></div>
<!-- start:MODAL -->
...
<div class="row-fluid"><div class="span12">
<label>Url Menu</label>
<input class="span12" name="menu_link" id="focusedInput" type="text" value="<?PHP echo MY_PATH;?>" placeholder="Link Menu"></div></div>
<div class="row-fluid"><div class="span12">
<label>Type Link Target :</label><select name='menu_target' style='width:100%'>
<option value='_self'>Same Windows (_self)</option>
<option value='_blank'>New Windows (_blank)</option>
...
<form class="form_validation_ttip" name="form1" action="<?PHP echo MY_ADMIN?>submenu-proses/?act=addmenu" enctype="multipart/form-data" method="post">
...
while ($data_for_menu = mysql_fetch_array($sql_for_menu)){$menu_name = $data_for_menu['name'];
$menu_id = $data_for_menu['id'];echo "<option value='$menu_id'>$menu_name</option>";}?>
</select>
</div></div>

<div class="row-fluid"><div class="span12">
<label>Url Menu</label>
<input class="span12" name="submenu_link" id="focusedInput" value="<?PHP echo MY_PATH?>" type="text" placeholder="Link Menu" required>
