...
$sql_edit=mysql_query("SELECT * FROM galery_categories WHERE link_categories='$ref'");
...
<form class="form_validation_ttip" name="form1" action="<?PHP echo MY_ADMIN?>proses-galery/?id=<?PHP echo $id;?>" method="post">
<div class="formSep">
<div class="row-fluid">
<div class="span12">
...
<form class="form_validation_ttip" name="form1" action="<?PHP echo MY_ADMIN?>proses-galery/"  method="post">
<div class="formSep">
<div class="row-fluid">
<div class="span12">
<label>Title <span class="f_req">*</span></label>
...
<div class="form-actions">
<button class="btn btn-primary btn-large" name="add_categories" type="submit"><i class="icon-ok"></i> Publish</button>
<button type="reset" class="btn btn-large"><i class="icon-eraser"></i> Reset</button></div>
</div></form>
</div></div>
<?PHP }?>
<div class="row-fluid">
<div class="span12">
<h3 class="heading">Categories Galery </h3>
...
<tbody>
<?php $sql=mysql_query("select * from galery_categories  order by galery_categories.id DESC");$no=0;
...
<td>
<a href="<?PHP echo MY_ADMIN?>galery/categories/?ref=<?PHP echo $link_categories;?>" target="_self">
<button class="btn btn-mini btn-primary ttip_t" title="Edit"><i class="icon-pencil"></i></button></a>

<a href="<?PHP echo MY_ADMIN?>proses-galery/?refidc=<?php echo $ref_idc; ?>&amp;action=delete_c"><button onClick="return confirm('Are you sure you want ot delete this thread.?');" class="btn btn-mini btn-danger ttip_t" title="Delete"><i class="icon-trash"></i></button></a></td></tr><?PHP }?></tbody></table>
</div></div>					
</div></div>
